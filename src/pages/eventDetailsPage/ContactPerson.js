  ...
  <Box sx={{mt:6}}>
      ...
      >
        ...
        <Box zIndex={1} flex={1} textAlign={isMobile ? 'center' : 'left'}>
          ...
          <Typography vsx={{  fontWeight: 400,
                fontSize: { xs: '18px', md: '24px' },
                fontFamily: 'poppins',color:'#666666'}} gutterBottom>
          ...
          <Stack spacing={1} mt={2} color="text.primary">
            <Typography sx={{  fontWeight: 400,
                ...
                style={{ 
                color: '#666666',
                fontFamily: 'poppins'}}>Phone:</span> 0952480820</Typography>
            <Typography sx={{  fontWeight: 400,
                fontSize: '24px',
                fontFamily: 'poppins',color:'#333333'}}><span  style={{ 
                color: '#666666',
                fontFamily: 'poppins'}}>Email:</span> emailaddress@gmail.com</Typography>
            <Typography sx={{  fontWeight: 400,
                fontSize: '24px',
                fontFamily: 'poppins',color:'#333333'}}><span  style={{ 
                color: '#666666',
                fontFamily: 'poppins'}}>Company:</span> Royal Property</Typography>
          </Stack>
