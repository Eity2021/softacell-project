...
export default function Dashboard() {
  ...
  const [showRegistrationLinkInput, setShowRegistrationLinkInput] =
    useState(false);
  ...
  return (
    <Box sx={{ margin: "auto", p: 3, bgcolor: "white" }}>
      <form onSubmit={handleSubmit(onSubmit)}>
                  ...
                  {preview ? (
                    ...
                    <>
                      <Typography variant="body1" fontWeight={600}>
                        Drag image or{" "}
                        <span style={{ color: "#0195FF" }}>Browse</span>
                      </Typography>
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    ...
                    onChange={(e) =>
                      setShowRegistrationLinkInput(e.target.checked)
                    }
                  />
                }
        ...
        <Box
          sx={{ display: "flex", justifyContent: "flex-end", gap: 2, ml: 2 }}
        >
          <Button
            variant="outlined"
            fullWidth
